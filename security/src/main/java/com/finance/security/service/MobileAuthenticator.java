...
@Service
public class MobileAuthenticator extends Authenticator {
    private final UserClient userClient;

    protected MobileAuthenticator(final UserClient userClient, final PasswordEncryptor passwordEncryptor,
    ...
    public Function<AuthenticationRequest, UserDTO> getUserFunction() {
        return request -> userClient.getUserByMobile(request.getUsername());
    }
}
